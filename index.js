                    ...
                    <div class="controls-grid">
                        <div class="form-group">
                            ...
                            <select class="form-select" id="voice">
                                <option value="" disabled>中文</option>
                                ...
                                <option value="" disabled>美式英语</option>
                                <option value="en-US-JennyNeural">Jenny (美国英语 - 女性 - 多语言)</option>
                                <option value="en-US-GuyNeural">Guy (美国英语 - 男性 - 新闻)</option>
                                <option value="en-US-AriaNeural">Aria (美国英语 - 女性 - 富有表现力)</option>
                                <option value="en-US-DavisNeural">Davis (美国英语 - 男性)</option>
                                <option value="en-US-AmberNeural">Amber (美国英语 - 女性)</option>
                                <option value="en-US-AndrewNeural">Andrew (美国英语 - 男性 - 多语言)</option>
                                <option value="en-US-AshleyNeural">Ashley (美国英语 - 女性)</option>
                                <option value="en-US-BrandonNeural">Brandon (美国英语 - 男性)</option>
                                <option value="en-US-BrianNeural">Brian (美国英语 - 男性 - 多语言)</option>
                                <option value="en-US-ChristopherNeural">Christopher (美国英语 - 男性)</option>
                                <option value="en-US-CoraNeural">Cora (美国英语 - 女性)</option>
                                <option value="en-US-ElizabethNeural">Elizabeth (美国英语 - 女性)</option>
                                <option value="en-US-EmmaNeural">Emma (美国英语 - 女性)</option>
                                <option value="en-US-EricNeural">Eric (美国英语 - 男性)</option>
                                <option value="en-US-JacobNeural">Jacob (美国英语 - 男性)</option>
                                <option value="en-US-JaneNeural">Jane (美国英语 - 女性)</option>
                                <option value="en-US-JasonNeural">Jason (美国英语 - 男性)</option>
                                <option value="en-US-MichelleNeural">Michelle (美国英语 - 女性)</option>
                                <option value="en-US-MonicaNeural">Monica (美国英语 - 女性)</option>
                                <option value="en-US-NancyNeural">Nancy (美国英语 - 女性)</option>
                                <option value="en-US-RogerNeural">Roger (美国英语 - 男性)</option>
                                <option value="en-US-RyanNeural">Ryan (美国英语 - 男性)</option>
                                <option value="en-US-SaraNeural">Sara (美国英语 - 女性)</option>
                                <option value="en-US-SteffanNeural">Steffan (美国英语 - 男性)</option>
                                <option value="en-US-TonyNeural">Tony (美国英语 - 男性)</option>
                                <option value="en-US-AnaNeural">Ana (美国英语 - 女性)</option>
                                <option value="en-US-AvaNeural">Ava (美国英语 - 女性 - 多语言)</option>
                                <option value="en-US-BlueNeural">Blue (美国英语 - 中性)</option>
                                <option value="en-US-SoniaNeural">Sonia (美国英语 - 女性)</option>
                                <option value="en-US-JennyMultilingualNeural">Jenny Multilingual (美国英语 - 女性 - 多语言增强)</option>
                                <option value="en-US-AvaMultilingualNeural">Ava Multilingual (美国英语 - 女性 - 多语言增强)</option>
                                <option value="en-US-AndrewMultilingualNeural">Andrew Multilingual (美国英语 - 男性 - 多语言增强)</option>
                                <option value="en-US-BrianMultilingualNeural">Brian Multilingual (美国英语 - 男性 - 多语言增强)</option>
                                <option value="en-US-AIGenerate1Neural">AI Generate 1 (美国英语 - AI生成)</option>
                                <option value="en-US-AIGenerate2Neural">AI Generate 2 (美国英语 - AI生成)</option>
                                <option value="" disabled>英式英语</option>
                                <option value="en-GB-SoniaNeural">Sonia (英国英语 - 女性)</option>
                                <option value="en-GB-RyanNeural">Ryan (英国英语 - 男性)</option>
                                <option value="en-GB-LibbyNeural">Libby (英国英语 - 女性)</option>
                                <option value="en-GB-AbbiNeural">Abbi (英国英语 - 女性)</option>
                                <option value="en-GB-AlfieNeural">Alfie (英国英语 - 男性)</option>
                                <option value="en-GB-BellaNeural">Bella (英国英语 - 女性)</option>
                                <option value="en-GB-ElliotNeural">Elliot (英国英语 - 男性)</option>
                                <option value="en-GB-EthanNeural">Ethan (英国英语 - 男性)</option>
                                <option value="en-GB-HollieNeural">Hollie (英国英语 - 女性)</option>
                                <option value="en-GB-ThomasNeural">Thomas (英国英语 - 男性)</option>
                                <option value="en-GB-OliviaNeural">Olivia (英国英语 - 女性)</option>
                                <option value="en-GB-MiaNeural">Mia (英国英语 - 女性)</option>
                                <option value="en-GB-NoahNeural">Noah (英国英语 - 男性)</option>
                                <option value="en-GB-OliverNeural">Oliver (英国英语 - 男性)</option>
                                <option value="en-GB-ReeceNeural">Reece (英国英语 - 男性)</option>
                                <option value="en-GB-SethNeural">Seth (英国英语 - 男性)</option>
                                <option value="en-GB-TracyNeural">Tracy (英国英语 - 女性)</option>
                                <option value="en-GB-WilliamNeural">William (英国英语 - 男性)</option>
                                <option value="en-GB-KennyNeural">Kenny (英国英语 - 男性)</option>
                                <option value="en-GB-LaurenNeural">Lauren (英国英语 - 女性)</option>
                                <option value="en-GB-MaisieNeural">Maisie (英国英语 - 女性)</option>
                            </select>
                        </div>
